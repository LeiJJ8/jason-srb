...
import com.happy.srb.core.mapper.LendItemMapper;
import com.happy.srb.core.pojo.vo.InvestVO;
import com.happy.srb.core.service.*;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public String commitInvest(InvestVO investVO) {
        ...
        BigDecimal amount = userAccountService.getUserAccountByUserId(investUserId).getAmount();
        Assert.isTrue(new BigDecimal(investVO.getInvestAmount()).compareTo(amount) <= 0, ResponseEnum.NOT_SUFFICIENT_FUNDS_ERROR);
    ...
    @Override
    public void toNotify(Map<String, Object> paramMap) {
        log.info("投标成功");
